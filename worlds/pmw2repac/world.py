...
class PMW2RepacWorld(World):
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        return self.options.as_dict("goal_boss", "level_randomizer", "random_starting_levels", "move_randomizer", "moves_to_randomize", "fruit_switches", "pac_dot_weight", "points_weight", "trap_weight")